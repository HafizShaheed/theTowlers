...
class CreatePackingListsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('packing_lists', function (Blueprint $table) {
            ...
            $table->text('heading_quantity', 50)->default('NET WT')->nullable();
            $table->text('heading_prices', 50)->default('GROSS WT')->nullable();
            $table->text('heading_total_amount', 50)->default('BALE/CARTON NO:')->nullable();
            ...
            $table->text('packing_list_invoice',50)->nullable();
            $table->timestamps();
        });
