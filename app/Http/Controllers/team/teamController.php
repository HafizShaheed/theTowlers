...
class teamController extends Controller
{
    ...
    public function submit_packing_list(Request $request)
    {
        ...
        try {
            ...
            $PackingList->team_user_id = Auth::guard('team')->user()->id;
    ...
    function edit_packing_list($id)
    {
        ...
        $data['PackingList']  = $invoice->toArray();
        // Fetch the related field data and merge it with the existing array under the same key
        ...
        $data['PackingList'] = array_merge($data['PackingList'], ...$relatedFieldsArrays);
    ...
    function activity_packing_list($id)
    {
        ...
        return view('team.report.packing-list.activity', $data);
    }
