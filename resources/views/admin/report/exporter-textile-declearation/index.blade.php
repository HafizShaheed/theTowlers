        ...
        <div class="card">
            <div class="card-body justify-content-start">
                ...
                <div class="col-xl-2 col-sm-6 col-6 mt-6 pt-2 ">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{ URL::to('/panel/report/exporter-textile-declearation/add') }}" class="" target="">
                            <button type="submit" class="btn btn report-tab-active"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <button class="btn btn-sm report-tab-active thirdpartyIdForFormResubmit" style="font-size: 10px;" href="javascript:void(0)"  data-thirdparty="{{ $value->id }}">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/exporter-textile-declearation/view/'.$value->id) }}" class="" target="" title="View Reports">
                                        View
                                    </a>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;"  href="{{ URL::to('/panel/report/exporter-textile-declearation/edit/'.$value->id) }}" class="" target="" title="Edit Reports">
                                        Edit
                                    </a>
                                    ...
                                    <span></span>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/exporter-textile-declearation/generate_exporter_textile_declearation_invoic_PDF/'.$value->id) }}" class="" target="" title="View Pdf">
                                    PDF
                                </a>

                                <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/exporter-textile-declearation/activity/'.$value->id) }}" class="" target=""  title="View Activity">
                               Activity
                                </a>
           ...
           confirmButtonText: 'Yes, re-submit!'
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('admin.form_exporter_textile_invoice_resubmit') }}",
        ...
        $('.thirdpartyIdForForComplete').on('click', function() {
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('admin.form_exporter_textile_invoice_completed') }}",
