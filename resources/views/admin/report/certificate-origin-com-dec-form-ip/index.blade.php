                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <button class="btn btn-sm report-tab-active" style="font-size: 10px;" href="javascript:void(0)" class="thirdpartyIdForFormResubmit" data-thirdparty="">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/certificate-origin-com-dec-from-ip/view/'.$value->id) }}" class="" target="_blank" title="View Reports">
                                        View
                                    </a>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;"  href="{{ URL::to('/panel/report/certificate-origin-com-dec-from-ip/edit/'.$value->id) }}" class="" target="_blank" title="Edit Reports">
                                        Edit
                                    </a>
