...
<body style="font-family: sans-serif;">
    ...
    <main>
        ...
        @for ($j = $start; $j <= $end; $j++)
            @if(!empty($CommercialInvoice['color_name_second_column_value_' . $j]) || 
                ...
                <tr style="font-size:8px; ">
                    ...
                    <td style=" border-right: 1px solid;">
                      ...
                      <div style="text-align: left; white-space: nowrap;">
                        <div style="display: inline-block; width: 19%; text-decoration: underline; margin-right: 1%; font-weight: bold; color: #000;">
                            {{ $CommercialInvoice['heading_color_' . $i] ?? '' }}
                        </div>
                        <div style="display: inline-block; width: 18%; text-decoration: underline; margin-right: 1%; font-weight: bold; color: #000;">
                        ...
                        <div style="display: inline-block; width: 18%; text-decoration: underline; font-weight: bold; color: #000;">
                    ...
                    <div style="text-align: left; white-space: nowrap; margin-top:3px">
                        ...
                        <div style="display: inline-block; width: 18%; text-decoration: underline; margin-right: 1%; color: #000;">
                            {{ $CommercialInvoice['sku_no_second_column_value_' . $j] ?? '' }}
                        </div>
                        <div style="display: inline-block; width: 18%; text-decoration: underline; margin-right: 1%; color: #000;">
                            {{ $CommercialInvoice['ean_no_second_column_value_' . $j] ?? '' }}
                        </div>
                        <div style="display: inline-block; width: 18%; text-decoration: underline; margin-right: 1%; color: #000;">
                        ...
                        <tr style="width: 50%;">
                            <td>
                                <div style="text-align: center;">
                                    <b>“{{ $CommercialInvoice['heading_statement_origin'] ?? '' }} ” </b></div>
                            </td>
