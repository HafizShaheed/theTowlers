        ...
        <div class="card-body justify-content-start">
            <form id="firm-step-form" enctype="multipart/form-data">
                ...
                <div class="col-sm-3 mb-3">
                    ...
                    <input type="text" class="form-control custom-input mb-1" id="carron_bales_pallets_value_{{ $i }}" name="carron_bales_pallets_value_{{ $i }}" placeholder="Eneter any  CARONS/BALES/PALLETS" value="{{ $CommercialInvoice['carron_bales_pallets_value_'.$i]}}">
                </div>
                <div class="col-sm-3 mb-3">
                    ...
                    <input type="text" class="form-control custom-input mb-1" id="pcs_pack_pallet_per_value_{{ $i }}" name="pcs_pack_pallet_per_value_{{ $i }}" placeholder="Enter any pcs/pack/pallet per value" value="{{ $CommercialInvoice['heading_terry_'.$i]}}">
                </div>
                <div class="col-sm-3 mb-3">
...
<input type="text" class="form-control custom-input" id="exporter_name" name="exporter_name" value="{{ $CommercialInvoice['']}}">
</div> --}}
