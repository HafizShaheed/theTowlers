            ...
            <form id="firm-step-form" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_po_number_{{ $i }}"  style="font-weight: bold; color: #000;"  name="heading_po_number_{{ $i }}"  value="{{ $CommercialInvoice['heading_po_number_' . $i]}}">
                        <input type="text" class="form-control custom-input mb-1" id="heading_po_number_value_{{ $i }}" name="heading_po_number_value_{{ $i }}" placeholder="ENTER  PO NUMBER :"  value="{{ $CommercialInvoice['heading_po_number_value_' . $i]}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_style_name_{{ $i }}" name="heading_style_name_{{ $i }}" style="font-weight: bold; color: #000;"  value="{{ $CommercialInvoice['heading_style_name_' . $i]}}">
                        <input type="text" class="form-control custom-input mb-1" id="heading_style_name_value_{{ $i }}" name="heading_style_name_value_{{ $i }}" placeholder="ENTER STYLE NAME " value="{{ $CommercialInvoice['heading_style_name_value_' . $i]}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_style_number_{{ $i }}" name="heading_style_number_{{ $i }}" style="font-weight: bold; color: #000;"  value="{{ $CommercialInvoice['heading_style_number_' . $i]}}">
                        <input type="text" class="form-control custom-input mb-1" id="heading_style_number_value_{{ $i }}" name="heading_style_number_value_{{ $i }}" placeholder="ENTER STYLE NUMBER " value="{{ $CommercialInvoice['heading_style_number_value_' . $i]}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_color_left_column_{{ $i }}" name="heading_color_left_column_{{ $i }}" style="font-weight: bold; color: #000;" value="{{ $CommercialInvoice['heading_color_left_column_' . $i]}}">
                        <input type="text" class="form-control custom-input mb-1" id="heading_color_left_column_value_{{ $i }}" name="heading_color_left_column_value_{{ $i }}" placeholder="ENTER COLOR NAME (left)"  value="{{ $CommercialInvoice['heading_color_left_column_value_' . $i]}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_size_break_down_{{ $i }}" name="heading_size_break_down_{{ $i }}" style="font-weight: bold; color: #000;" value="{{ $CommercialInvoice['heading_size_break_down_' . $i]}}">
                        <input type="text" class="form-control custom-input mb-1" id="heading_size_break_down_value_{{ $i }}" name="heading_size_break_down_value_{{ $i }}" placeholder="ENTER SIZE BREAKDOWN " value="{{ $CommercialInvoice['heading_size_break_down_value_' . $i]}}">
                    </div>

                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_carton_count_{{ $i }}" name="heading_carton_count_{{ $i }}" style="font-weight: bold; color: #000;"  value="{{ $CommercialInvoice['heading_carton_count_' . $i]}}">
                        <input type="text" class="form-control custom-input mb-1" id="heading_carton_count_value_{{ $i }}" name="heading_carton_count_value_{{ $i }}" placeholder="ENTER CARTON COUNT "  value="{{ $CommercialInvoice['heading_carton_count_value_' . $i]}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_carton_size_{{ $i }}" name="heading_carton_size_{{ $i }}" style="font-weight: bold; color: #000;" value="{{ $CommercialInvoice['heading_carton_size_' . $i]}}">
                        <input type="text" class="form-control custom-input mb-1" id="heading_carton_size_value_{{ $i }}" name="heading_carton_size_value_{{ $i }}" placeholder="ENTER CARTON SIZE "  value="{{ $CommercialInvoice['heading_carton_size_value_' . $i]}}">
                    </div>

                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_bale_left_column_{{ $i }}" name="heading_bale_left_column_{{ $i }}" style="font-weight: bold; color: #000;"  value="{{ $CommercialInvoice['heading_bale_left_column_' . $i]}}">
                        <input type="text" class="form-control custom-input mb-1" id="heading_bale_left_column_value_{{ $i }}" name="heading_bale_left_column_value_{{ $i }}" placeholder="ENTER BALE#: (left column ) "  value="{{ $CommercialInvoice['heading_bale_left_column_value_' . $i]}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_net_weight_left_column_{{ $i }}" name="heading_net_weight_left_column_{{ $i }}" style="font-weight: bold; color: #000;" value="{{ $CommercialInvoice['heading_net_weight_left_column_' . $i]}}">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_gross_weight_left_column_{{ $i }}" name="heading_gross_weight_left_column_{{ $i }}" style="font-weight: bold; color: #000;"  value="{{ $CommercialInvoice['heading_gross_weight_left_column_' . $i]}}" style="font-weight: bold; color: #000;">
                    </div>
                  ...
                  <div class="col-sm-3 mb-3">
                    ...
                    <input type="text" class="form-control custom-input" id="performa_invioce_no_value" name="performa_invioce_no_value"
                       value="{{ $CommercialInvoice['performa_invioce_no_value'] }}">
                </div>
                <br>
                <hr>
                    @for ($i = 1; $i <= 5; $i++)
                ...
                @endfor
                    ...
                    <hr>
                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_net_weight_second_column_{{ $i }}"  value="{{ $CommercialInvoice['heading_net_weight_second_column_' .$i]}}" name="heading_net_weight_second_column_{{ $i }}" style="font-weight: bold; color: #000;">
                        <input type="text" class="form-control custom-input mb-1" id="net_weight_second_column_value_{{ $i }}"  value="{{ $CommercialInvoice['net_weight_second_column_value_' . $i]}}" name="net_weight_second_column_value_{{ $i }}" placeholder="ENTER Net weight#: (second column ) ">
                        
                    </div>
                    <div class="col-sm-3 mb-3">
                        <input type="text" style="background-color: #616161; color:#000; font-weight: 700"  class="form-control custom-input mb-1" id="heading_gross_weight_second_column_{{ $i }}"  value="{{ $CommercialInvoice['heading_gross_weight_second_column_' . $i]}}" name="heading_gross_weight_second_column_{{ $i }}" style="font-weight: bold; color: #000;" >
                        <input type="text" class="form-control custom-input mb-1" id="gross_weight_second_column_value_{{ $i }}"  value="{{ $CommercialInvoice['gross_weight_second_column_value_' . $i]}}" name="gross_weight_second_column_value_{{ $i }}" placeholder="ENTER gross weight#: (second column ) ">
