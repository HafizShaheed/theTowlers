                ...
                <form id="firm-step-form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                            ...
                            <select class="multi-select" name="commercial_invoice_id" placeholder="Select status Party">
                                ...
                                @forelse ($getAllInvoice as $item)
                                    <option value="{{ $item->id }}"
                                        {{ isset($CertificateOrigin) && $item->id == $CertificateOrigin->commercial_invoice_id ? 'selected' : '' }}>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="certificate_origin_invoices"
                                name="certificate_origin_invoices"
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="exporter_address"
                                name="exporter_address" value="{{ $CertificateOrigin->exporter_address }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="consignee_name"
                                name="consignee_name" value="{{ $CertificateOrigin->consignee_name }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="ref_number" name="ref_number"
                                value="{{ $CertificateOrigin->ref_number }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="exporter_membership_number"
                                ...
                                value="{{ $CertificateOrigin->exporter_membership_number }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="particular_of_transport"
                                name="particular_of_transport" value="{{ $CertificateOrigin->particular_of_transport }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="full_name" name="full_name"
                                value="{{ $CertificateOrigin->full_name }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="signature_person_authorized"
                                name="signature_person_authorized"
                                value="{{ $CertificateOrigin->signature_person_authorized }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                        ...
                        @for ($i = 1; $i <= 1; $i++)
                            <div class="col-sm-4 mb-4">
                                ...
                                <input type="text" class="form-control custom-input"
                                    ...
                                    value="{{ $CertificateOrigin->{'marks_and_numbers_' . $i} }}">
                            </div>

                            <div class="col-sm-4 mb-4">
                                <label for="numbers_and_kinds_of_packges_{{ $i }}" class="form-label">Numbers
                                    and kinds of packges</label>
                                <input type="text" step="any" class="form-control custom-input"
                                    id="numbers_and_kinds_of_packges_{{ $i }}"
                                    name="numbers_and_kinds_of_packges_{{ $i }}"
                                    value="{{ $CertificateOrigin->{'numbers_and_kinds_of_packges_' . $i} }}">
                            </div>
                        @endfor
                    </div>
                    <br><hr>
                        ...
                        @for ($i = 1; $i <= 16; $i++)
                            <div class="col-sm-4 mb-4">
                                ...
                                <input type="text" step="any" class="form-control custom-input"
                                    ...
                                    value="{{ $CertificateOrigin->{'description_of_goods_' . $i} }}">
                            </div>
                            ...
                            <div class="col-sm-4 mb-4">
                                ...
                                <input type="text" step="any" class="form-control custom-input"
                                    ...
                                    value="{{ $CertificateOrigin->{'gross_weight_or_other_quantity_' . $i} }}">
                            </div>
                            ...
                            {{-- <div class="col-sm-4 mb-4">
                                ...
                                <input type="text" step="any" class="form-control custom-input"
                                    ...
                                    value="{{ $CertificateOrigin->{'county_of_origin_' . $i} }}">
                            </div> --}}
                            <hr>
                        @endfor
                        <!-- =========== Director1 ============ -->
        ...
        $(document).ready(function() {
            ...
            $('#firm-step-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.update_submit_certificate_origins_invoice') }}",
                    data: formData,
                    dataType: "json",
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            willClose: () => {
                                ...
                                //    "{{ route('admin.report_List_certificate_origins_invoice') }}"
