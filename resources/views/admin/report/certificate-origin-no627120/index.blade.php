        ...
        <div class="card">
            <div class="card-body justify-content-start">
                ...
                <div class="col-xl-2 col-sm-6 col-6 mt-6 pt-2 ">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{ URL::to('/panel/report/certificate-origin-no627120/add') }}" class="" target="">
                            <button type="submit" class="btn btn report-tab-active"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <button class="btn btn-sm report-tab-active thirdpartyIdForFormResubmit" style="font-size: 10px;" href="javascript:void(0)"  data-thirdparty="{{ $value->id }}">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/certificate-origin-no627120/view/'.$value->id) }}" class="" target="" title="View Reports">
                                        View
                                    </a>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;"  href="{{ URL::to('/panel/report/certificate-origin-no627120/edit/'.$value->id) }}" class="" target="" title="Edit Reports">
                                        Edit
                                    </a>
                                    ...
                                    <span></span>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/certificate-origin-no627120/generate_certificate_origin_no627120_invoic_PDF/'.$value->id) }}" class="" target="" title="View Pdf">
                                    PDF
                                </a>

                                <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/certificate-origin-no627120/activity/'.$value->id) }}" class="" target=""  title="View Activity">
                               Activity
                                </a>
