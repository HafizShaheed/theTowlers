    ...
    <div class="card">
        <div class="card-body justify-content-start">
            <form id="firm-step-form" enctype="multipart/form-data">
                ...
                <input type="hidden" class="form-control custom-input" id="id" name="id" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->id}}">
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="vender_address" name="vender_address"
                            disabled readonly value="{{$editCanadaCustomerInvoiceFrom->vender_address}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="vender_nom_et_adresse"
                            name="vender_nom_et_adresse" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->vender_nom_et_adresse}}">
                    </div>
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="date_of_direct_shipment_to_canada_1"
                            name="date_of_direct_shipment_to_canada_1" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->date_of_direct_shipment_to_canada_1}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="date_of_direct_shipment_to_canada_2"
                            name="date_of_direct_shipment_to_canada_2" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->date_of_direct_shipment_to_canada_2}}">
                    </div>
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="consignee_name" name="consignee_name"
                            disabled readonly value="{{$editCanadaCustomerInvoiceFrom->consignee_name}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="consignee_nom_et_adresse"
                            name="consignee_nom_et_adresse" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->consignee_nom_et_adresse}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="purchaser_name" name="purchaser_name"
                            disabled readonly value="{{$editCanadaCustomerInvoiceFrom->purchaser_name}}">
                    </div>
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="purchaser_nom_et_adresse"
                            name="purchaser_nom_et_adresse" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->purchaser_nom_et_adresse}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="originator_name" name="originator_name"
                            disabled readonly value="{{$editCanadaCustomerInvoiceFrom->originator_name}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="originator_address"
                            name="originator_address" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->originator_address}}">
                    </div>
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="originator_nom_et_adresse"
                            name="originator_nom_et_adresse" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->originator_nom_et_adresse}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="exporter_name" name="exporter_name"
                            disabled readonly value="{{$editCanadaCustomerInvoiceFrom->exporter_name}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="exporter_nom_et_adresse"
                            name="exporter_nom_et_adresse" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->exporter_nom_et_adresse}}">
                    </div>
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input"
                            ...
                            name="transportation_place_of_direct_shipment_to_canada" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->transportation_place_of_direct_shipment_to_canada}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="country_of_origin_pays"
                            name="country_of_origin_pays" disabled readonly value="{{$editCanadaCustomerInvoiceFrom->country_of_origin_pays}}">
                    </div>
                    <div class="col-sm-3 mb-3">
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="agency_ruling" name="agency_ruling"
                            disabled readonly value="{{$editCanadaCustomerInvoiceFrom->agency_ruling}}">
                    </div>
                ...
                <div class="row">
                    ...
                    @for($i=1; $i <= 6; $i++) <div class="col-sm-4 mb-4">
                        ...
                        <input type="text" class="form-control custom-input"
                            ...
                            name="number_of_packages_nombre_de_coils_{{ $i }}" disabled readonly value="{{ $editCanadaCustomerInvoiceFrom->{'number_of_packages_nombre_de_coils_' . $i} }}">
                </div>
                ...
                <div class="col-sm-4 mb-4">
                    ...
                    <input type="number" step="any" class="form-control custom-input" id="unit_price_{{ $i }}"
                        name="unit_price_{{ $i }}" disabled readonly value="{{ $editCanadaCustomerInvoiceFrom->{'unit_price_' . $i} }}">
                </div>
