                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center space-between ">
                                    ...
                                    <a href="{{ URL::to('/panel/report/canda-costom_invoice/view') }}" class="" target="_blank" title="View Reports">
                                    ...
                                    <a  href="{{ URL::to('/panel/report/canda-costom_invoice/edit/'.$value->id) }}" class="" target="_blank" title="Edit Reports">
                                    ...
                                    <span></span>
                                    <a href="{{ URL::to('/panel/report/canda-costom_invoice/generate_custom_canda_invoic_PDF/'.$value->id) }}" class="" target="_blank" title="View Pdf">
                                ...
                                <a href="{{ URL::to('/panel/report/canda-costom_invoice/activity/'.$value->id) }}" class="" target="_blank"  title="View Activity">
