    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body justify-content-start">
                <form id="" action="{{route('admin.report_List_certificate_origin_chaina_invoice')}}" class="row d-flex justify-content-between align-items-end">
                    ...
                    <div class="col-xl-1 col-sm-6 col-6 mt-4 mt-md-0">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{route('admin.report_List_certificate_origin_chaina_invoice')}}" class="btn btn report-tab-unactive"
                ...
                <div class="col-xl-2 col-sm-6 col-6 mt-6 pt-2 ">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{ URL::to('/panel/report/certificate-origin-chaina/add') }}" class="" target="">
                            <button type="submit" class="btn btn report-tab-active"
                    ...
                    <table id="empoloyees-tblwrapper" class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span>{{$value->certificate_origin_chaina_invoices ?? ""}}</span>
                                </td>
                                <?php
                                ...
                                <button class="btn btn-sm report-tab-active thirdpartyIdForFormResubmit" style="font-size: 10px;" href="javascript:void(0)"  data-thirdparty="{{ $value->id }}">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/certificate-origin-chaina/view/'.$value->id) }}"  target="" title="View Reports">
                                        View
                                    </a>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;"  href="{{ URL::to('/panel/report/certificate-origin-chaina/edit/'.$value->id) }}"  target="" title="Edit Reports">
                                        Edit
                                    </a>
                                    ...
                                    <span></span>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/certificate-origin-chaina/generate_certificate_origin_chaina_invoic_PDF/'.$value->id) }}" class="" target="" title="View Pdf">
                                    PDF
                                </a>

                                <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/certificate-origin-chaina/activity/'.$value->id) }}" class="" target=""  title="View Activity">
                               Activity
                                </a>
           ...
           confirmButtonText: 'Yes, re-submit!'
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('admin.form_certificate_origin_chaina_invoice_resubmit') }}",
