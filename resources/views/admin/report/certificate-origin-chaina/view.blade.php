            ...
            <form id="firm-step-form" enctype="multipart/form-data">
                ...
                <div class="row">
                    {{-- <div class="col-sm-3 mb-3">
                        ...
                        <select disabled readonly class="multi-select" name="commercial_invoice_id" placeholder="Select status Party">
                            ...
                            @forelse ($getAllInvoice as $item)
                                <option   readonly disabled  value="{{ $item->id }}" {{ isset($CertificateOriginComDecFormIp) && $item->id == $CertificateOriginComDecFormIp->commercial_invoice_id ? 'selected' : '' }}>
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="certificate_origin_chaina_invoices" name="certificate_origin_chaina_invoices"
                              readonly disabled  value="{{ $CertificateOriginComDecFormIp->certificate_origin_chaina_invoices }}">
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="date"
                            name="date"   readonly disabled  value="{{ $CertificateOriginComDecFormIp->date }}">
                    </div>
                    <div class="col-sm-3 mb-3">
                    ...
                    {{-- <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="expoter_manager_name" name="expoter_manager_name"
                              readonly disabled  value="{{ $CertificateOriginComDecFormIp->expoter_manager_name }}">
                    </div> --}}
                ...
                <div class="col-sm-4 mb-4">
                    ...
                    <input type="text" step="any" class="form-control custom-input" id="remarks_{{ $i }}"
                        name="remarks_{{ $i }}"    readonly disabled  value="{{ $CertificateOriginComDecFormIp->{'remarks_' . $i} }}">
                </div>
                <hr>
