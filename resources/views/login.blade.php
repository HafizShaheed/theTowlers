...
<meta name="format-detection" content="telephone=no">
    <!-- PAGE TITLE HERE -->
    <title>The Towellers  | Client-Login </title>
    <!-- FAVICONS ICON -->
    ...
    <div class="col-xl-6 col-lg-6">
		...
		<div class="col-lg-6 col-md-12 col-sm-12 mx-auto align-self-center">
			<div class="login-form">
                ...
                <form action="{{ route('web.login_Submit_client') }}" method="POST">
                  @csrf
					<div class="mb-4">
					...
					<div class="mb-4 position-relative">
						...
						<input type="password" id="dz-password" class="form-control form-control" value="123456" name="password">
