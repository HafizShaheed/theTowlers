        ...
        <div class="card">
            <div class="card-body justify-content-start">
                <form id="" action="{{route('team.report_List_commercial_invoice')}}" class="row d-flex justify-content-between align-items-end">
                    ...
                    <div class="col-xl-1 col-sm-6 col-6 mt-4 mt-md-0">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{route('team.report_List_commercial_invoice')}}" class="btn btn report-tab-unactive"
                ...
                <div class="col-xl-2 col-sm-6 col-6 mt-6 pt-2 ">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{ URL::to('/panel-team/report/commercial-invoice/add') }}" class="" target="">
                            <button type="submit" class="btn btn report-tab-active"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center space-between ">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/commercial-invoice/view/'.$value->id) }}" class="" target="" title="View Reports">
                                        View
                                    </a>
                                    ...
                                    <span></span>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/commercial-invoice/generate_commercial_invoice_PDF/'.$value->id) }}" class="" target="" title="View Pdf">
                                    PDF
                                </a>


                             
                                <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/commercial-invoice/commercial_invoice_by_pdf/'.base64_encode($value->id)) }}" class="" target="" title="View Pdf">
                                    Related Invoice
                                </a>
                                ...
                                <a class="btn btn-sm report-tab-active" style="font-size: 10px; {{ isset($value->pdf_upload_file_ic) || !empty($value->pdf_upload_file_ic) ?  'background-color: #2032ae !important;' : 'background-color: #45ae20 !important; pointer-events: none;  cursor: default; text-decoration: none;' }}" 
                                    href="{{ URL::to('/panel-team//report/commercial-invoice/pdf_file_view/' . base64_encode($value->id)) }}"
           ...
           confirmButtonText: 'Yes, re-submit!'
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('team.commercial_invoice_resubmit') }}",
                       ...
                       success: function(response) {
                           ...
                           Swal.fire({
                               ...
                               willClose: () => {
                                   window.location.href = '{{ route("team.report_List_commercial_invoice") }}';
                               },
                           });
                       },
        ...
        $('.thirdpartyIdForForComplete').on('click', function() {
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('team.commercial_invoice_completed') }}",
