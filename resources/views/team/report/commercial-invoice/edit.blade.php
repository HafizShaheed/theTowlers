                ...
                <form id="firm-step-form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" class="form-control custom-input" id="id" name="id"
                            value="{{ $editCanadaCustomerInvoiceFrom->id }}">
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="vender_address"
                                name="vender_address" value="{{ $editCanadaCustomerInvoiceFrom->vender_address }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="date_of_direct_shipment_to_canada_1"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->date_of_direct_shipment_to_canada_1 }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="date_of_direct_shipment_to_canada_2"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->date_of_direct_shipment_to_canada_2 }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="consignee_name"
                                name="consignee_name" value="{{ $editCanadaCustomerInvoiceFrom->consignee_name }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="purchaser_name"
                                name="purchaser_name" value="{{ $editCanadaCustomerInvoiceFrom->purchaser_name }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="originator_name"
                                name="originator_name" value="{{ $editCanadaCustomerInvoiceFrom->originator_name }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="originator_address"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->originator_address }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="exporter_name"
                                name="exporter_name" value="{{ $editCanadaCustomerInvoiceFrom->exporter_name }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="country_of_transhipment"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->country_of_transhipment }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->transportation_place_of_direct_shipment_to_canada }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="country_of_origin_pays"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->country_of_origin_pays }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="currency_of_transhipment"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->currency_of_transhipment }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="checkbox" class="form-check-input"
                                ...
                                name="yes_or_no_If_any_of_fields_1_to_17_are_included" value="1"
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="checkbox" class="form-check-input"
                                ...
                                name="yes_or_no_If_any_of_fields_23_to_35_are_not_applicable" value="1"
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="agency_ruling"
                                name="agency_ruling" value="{{ $editCanadaCustomerInvoiceFrom->agency_ruling }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->{'23_agency_if_included_in_field_17_indicate'} ?? '' }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="23_agency_transportation_charges"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->{'23_agency_transportation_charges'} ?? '' }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="23_agency_costs_for_contruction"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->{'23_agency_costs_for_contruction'} ?? '' }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="23_agency_exporting_packing"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->{'23_agency_exporting_packing'} ?? '' }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->{'24_agency_if_included_in_field_17_indicate'} ?? '' }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="24_agency_transportation_charges"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->{'24_agency_transportation_charges'} ?? '' }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="24_agency_costs_for_contruction"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->{'24_agency_costs_for_contruction'} ?? '' }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="24_agency_exporting_packing"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->{'24_agency_exporting_packing'} ?? '' }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input"
                                ...
                                value="{{ $editCanadaCustomerInvoiceFrom->{'25_agency_if_included_in_field_17_indicate'} ?? '' }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="checkbox" class="form-check-input"
                                ...
                                name="yes_or_no_25_agency_transportation_charges" value="1"
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="checkbox" class="form-check-input"
                                ...
                                name="yes_or_no_25_agency_costs_for_contruction" value="1"
                        ...
                        @for ($i = 1; $i <= 6; $i++)
                            <div class="col-sm-3 mb-4">
                                ...
                                <input type="text" class="form-control custom-input"
                                    ...
                                    value="{{ $editCanadaCustomerInvoiceFrom->{'number_of_packages_nombre_de_coils_' . $i} }}">
                            </div>
                            ...
                            <div class="col-sm-3 mb-4">
                                ...
                                <input type="number" step="any" class="form-control custom-input"
                                    ...
                                    value="{{ $editCanadaCustomerInvoiceFrom->{'unit_price_' . $i} }}">
                            </div>
                        @endfor
                        <!-- =========== Director1 ============ -->
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function calculateNetAbleAmount() {
                ...
                var netAbleAmount = (grandTotal + value_total_add_fright) - (value_total_less_commission +
                    value_total_buyer_discount);
                console.log(netAbleAmount, 'netAbleAmount');
                var total_net_amount_payable = parseFloat($('#value_total_net_amount_payable').val(netAbleAmount
                    .toFixed(2))) || 0;
                console.log(total_net_amount_payable, 'total_net_amount_payable');
            }

            $(document).on('input',
                'input.total_buyer_discount, input.total_less_commission, input.total_add_fright',
                function() {
                    calculateNetAbleAmount();
                });
