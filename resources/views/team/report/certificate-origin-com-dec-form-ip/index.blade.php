    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body justify-content-start">
                <form id="" action="{{route('team.report_List_certificate_origin_com_dec_form_ip_invoice')}}" class="row d-flex justify-content-between align-items-end">
                    ...
                    <div class="col-xl-1 col-sm-6 col-6 mt-4 mt-md-0">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{route('team.report_List_certificate_origin_com_dec_form_ip_invoice')}}" class="btn btn report-tab-unactive"
                ...
                <div class="col-xl-2 col-sm-6 col-6 mt-6 pt-2 ">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{ URL::to('/panel-team/report/certificate-origin-com-dec-from-ip/add') }}" class="" target="_blank">
                            <button type="submit" class="btn btn report-tab-active"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center space-between ">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/certificate-origin-com-dec-from-ip/view/'.$value->id) }}"  target="_blank" title="View Reports">
                                        View
                                    </a>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;"  href="{{ URL::to('/panel-team/report/certificate-origin-com-dec-from-ip/edit/'.$value->id) }}"  target="_blank" title="Edit Reports">
                                        Edit
                                    </a>
                                    ...
                                    <span></span>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/certificate-origin-com-dec-from-ip/generate_certificate_origin_com_dec_form_ip_invoic_PDF/'.$value->id) }}" class="" target="_blank" title="View Pdf">
                                    PDF
                                </a>
        ...
        $('.thirdpartyIdForForComplete').on('click', function() {
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('team.form_certificate_origin_com_dec_form_ip_invoice_completed') }}",
