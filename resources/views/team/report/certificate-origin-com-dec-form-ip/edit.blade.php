                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="declaration_by_the_exporter_country"
                           name="declaration_by_the_exporter_country"  value="{{ $CertificateOriginComDecFormIp->declaration_by_the_exporter_country }}">
                    </div>
...
$(document).ready(function() {
    ...
    $('#firm-step-form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: "{{ route('team.update_submit_certificate_origin_com_dec_form_ip_invoice') }}",
            data: formData,
            dataType: "json",
                ...
                Swal.fire({
                    ...
                    willClose: () => {
                        window.location.href =
                            "{{ route('team.report_List_certificate_origin_com_dec_form_ip_invoice') }}"
