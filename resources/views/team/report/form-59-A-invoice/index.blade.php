    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body justify-content-start">
                <form id="" action="{{route('team.report_List_custom_canda_invoice')}}" class="row d-flex justify-content-between align-items-end">
                    ...
                    <div class="col-xl-1 col-sm-6 col-6 mt-4 mt-md-0">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{route('team.report_List_form_59_a_invoice')}}" class="btn btn report-tab-unactive"
                ...
                <div class="col-xl-2 col-sm-6 col-6 mt-6 pt-2 ">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{ URL::to('/panel/report/form-59-a-invoice/add') }}" class="" target="_blank">
                            <button type="submit" class="btn btn report-tab-active"
                ...
                <!-- <form id="" action="{{route('team.report_List_form_59_a_invoice')}}" class="row d-flex justify-content-between align-items-end">
            ...
            <div class="card-body p-0">
                <div class="table-responsive active-projects style-1">
                    ...
                    <table id="empoloyees-tblwrapper" class="table ">
                        ...
                        <tbody>
                            @foreach ($Form59AInvoice as $key => $value )
                            <tr>
                                ...
                                <button class="btn btn-sm report-tab-active thirdpartyIdForFormResubmit" style="font-size: 10px;" href="javascript:void(0)"  data-thirdparty="{{ $value->id }}">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/form-59-a-invoice/view/'.$value->id) }}" class="" target="_blank" title="View Reports">
                                        View
                                    </a>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;"  href="{{ URL::to('/panel/report/form-59-a-invoice/edit/'.$value->id) }}" class="" target="_blank" title="Edit Reports">
                                        Edit
                                    </a>
                                    ...
                                    <span></span>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/form-59-a-invoice/generate_form_59_a_invoic_PDF/'.$value->id) }}" class="" target="_blank" title="View Pdf">
                                    PDF
                                </a>

                                <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel/report/form-59-a-invoice/activity/'.$value->id) }}" class="" target="_blank"  title="View Activity">
                               Activity
                                </a>
            ...
            confirmButtonText: 'Yes, re-submit!'
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('team.form_59_invoice_resubmit') }}",
                        ...
                        success: function(response) {
                            ...
                            Swal.fire({
                                ...
                                willClose: () => {
                                    window.location.href = '{{ route("team.report_List_form_59_a_invoice") }}';
                                },
                            });
                        },
         ...
         $('.thirdpartyIdForForComplete').on('click', function() {
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('team.form_59_invoice_completed') }}",
