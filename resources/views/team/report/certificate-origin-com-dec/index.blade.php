    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body justify-content-start">
                <form id="" action="{{route('team.report_List_certificate_origin_com_dec_invoice')}}" class="row d-flex justify-content-between align-items-end">
                    ...
                    <div class="col-xl-1 col-sm-6 col-6 mt-4 mt-md-0">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{route('team.report_List_certificate_origin_com_dec_invoice')}}" class="btn btn report-tab-unactive"
                ...
                <div class="col-xl-2 col-sm-6 col-6 mt-6 pt-2 ">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{ URL::to('/panel-team/report/certificate-origin-com-dec/add') }}" class="" target="_blank">
                            <button type="submit" class="btn btn report-tab-active"
                    ...
                    <table id="empoloyees-tblwrapper" class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php
                                if (isset($CertificateOriginComDec->team_user_id)) {
                                    # code...
                                    $memberName = App\Models\team\TeamUser::where('id',$CertificateOriginComDec->team_user_id)->first('user_name');
                                }
                                ?>
                                ...
                                <td class="text-center space-between ">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/certificate-origin-com-dec/view/'.$value->id) }}" class="" target="_blank" title="View Reports">
                                        View
                                    </a>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;"  href="{{ URL::to('/panel-team/report/certificate-origin-com-dec/edit/'.$value->id) }}" class="" target="_blank" title="Edit Reports">
                                        Edit
                                    </a>
                                    ...
                                    <span></span>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/certificate-origin-com-dec/generate_certificate_origin_com_dec_invoic_PDF/'.$value->id) }}" class="" target="_blank" title="View Pdf">
                                    PDF
                                </a>
        ...
        $('.thirdpartyIdForForComplete').on('click', function() {
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('team.form_certificate_origin_com_dec_invoice_completed') }}",
                       ...
                       success: function(response) {
                           ...
                           Swal.fire({
                               ...
                               willClose: () => {
                                   window.location.href = '{{ route("team.report_List_certificate_origin_com_dec_invoice") }}';
                               },
                           });
                       },
