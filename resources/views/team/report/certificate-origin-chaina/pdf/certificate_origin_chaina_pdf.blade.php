    ...
    <table style="border: 1px solid #000; border-collapse: collapse; width: 100%; font-size: 10px; border-top: 0;">
        ...
        <tr style="text-align: center">
            <td style="border-right: 1px solid #000; width: 10%;">
                <div style="width: 78px; word-wrap: break-word; height: 120px;">
                    @for($i = 1; $i <= 4; $i++) @if(isset($CertificateOriginComDecFormIp["item_number_" . $i])) 
            ...
            <td style="border-right: 1px solid #000; width: 20%;">
                <div style="width: 237px; word-wrap: break-word; height: 120px; text-align: justify;">
                    @for($i = 1; $i <= 4; $i++) @if(isset($CertificateOriginComDecFormIp["marks_and_numbers_" . $i])) 
                    <ul style="list-style: none; padding: 2px; margin-top: 0px;">
            ...
            <td style="border-right: 1px solid #000; width: 15%;">
                <div style="width: 80px; word-wrap: break-word; height: 120px;">
                    @for($i = 1; $i <= 4; $i++) @if(isset($CertificateOriginComDecFormIp["origin_criterion_" . $i])) 
                    <ul style="list-style: none; padding: 2px; margin-top: 0px;">
            ...
            <td style="border-right: 1px solid #000; width: 20%;">
                <div style="width: 130px; word-wrap: break-word; height: 120px;">
    ...
    <table style="border: 1px solid #000; border-collapse: collapse; width: 100%; border-top: 0; ">
        <tr style="font-size: 12px; ">
            ...
            <td style="width: 50%; border-left: 1px solid #000;">
                ...
                <div style="height: 270px; padding: 10px; margin-bottom: 66px;">
                    13. Certificate <br>
                    ...
                    correct <br>
                    <input type="text"
                        style="border: 0; border-bottom: 1px dotted #000; margin-top: 254px; width: 250px;"><br>
