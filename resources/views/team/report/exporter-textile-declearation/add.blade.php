    ...
    <div class="card">
        <div class="card-body justify-content-start">
            <form id="firm-step-form" enctype="multipart/form-data">
                ...
                <h4 class="card-title"> {{strtoupper("Exporter textile declearation Invoice Add")}} <br>
...
$(document).ready(function() {
    ...
    $('#firm-step-form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: "{{ route('team.submit_exporter_textile_declearation_invoice') }}",
            data: formData,
            dataType: "json",
