    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body justify-content-start">
                <form id="" action="{{route('team.report_List_exporter_textile_declearation_invoice')}}" class="row d-flex justify-content-between align-items-end">
                    ...
                    <div class="col-xl-1 col-sm-6 col-6 mt-4 mt-md-0">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{route('team.report_List_exporter_textile_declearation_invoice')}}" class="btn btn report-tab-unactive"
                    ...
                    <table id="empoloyees-tblwrapper" class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php
                                 if (isset($exporter_textile_declearation_invoices->team_user_id)) {
                                    # code...
                                    $memberName = App\Models\team\TeamUser::where('id',$exporter_textile_declearation_invoices->team_user_id)->first('user_name');
                                }
                                ?>
        ...
        $('.thirdpartyIdForForComplete').on('click', function() {
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('team.form_exporter_textile_invoice_completed') }}",
                       ...
                       success: function(response) {
                           ...
                           Swal.fire({
                               ...
                               willClose: () => {
                                   window.location.href = '{{ route("team.report_List_exporter_textile_declearation_invoice") }}';
                               },
                           });
                       },
