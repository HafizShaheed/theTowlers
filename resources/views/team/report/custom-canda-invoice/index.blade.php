        ...
        <div class="card">
            <div class="card-body justify-content-start">
                ...
                <div class="col-xl-2 col-sm-6 col-6 mt-6 pt-2 ">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{ URL::to('/panel-team/report/canda-costom_invoice/add') }}" class="" target="">
                            <button type="submit" class="btn btn report-tab-active"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center space-between ">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/canda-costom_invoice/view/'.$value->id)}}" class="" target="" title="View Reports">
                                        View
                                    </a>
                                    @if ( $value->status ==2  || $value->status ==1)
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;"  href="{{ URL::to('/panel-team/report/canda-costom_invoice/edit/'.$value->id) }}" class="" target="" title="Edit Reports">
                                        Edit
                                    </a>
                                    @endif
                                    ...
                                    <span></span>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/canda-costom_invoice/generate_custom_canda_invoic_PDF/'.$value->id) }}" class="" target="" title="View Pdf">
                                    PDF
                                </a>
