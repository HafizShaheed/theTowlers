    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body justify-content-start">
                <form id="" action="{{route('team.report_List_certificate_origin_no627120_invoice')}}" class="row d-flex justify-content-between align-items-end">
                    ...
                    <div class="col-xl-1 col-sm-6 col-6 mt-4 mt-md-0">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{route('team.report_List_certificate_origin_no627120_invoice')}}" class="btn btn report-tab-unactive"
           ...
           confirmButtonText: 'Yes, re-submit!'
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('team.form_certificate_origin_no627120_invoice_resubmit') }}",
                       ...
                       success: function(response) {
                           ...
                           Swal.fire({
                               ...
                               willClose: () => {
                                   window.location.href = '{{ route("team.report_List_certificate_origin_no627120_invoice") }}';
                               },
                           });
                       },
        ...
        $('.thirdpartyIdForForComplete').on('click', function() {
               ...
               if (result.isConfirmed) {
                   ...
                   $.ajax({
                       ...
                       url: "{{ route('team.form_certificate_origin_no627120_invoice_completed') }}",
