        ...
        <div class="card">
            <div class="card-body justify-content-start">
                ...
                <div class="col-xl-2 col-sm-6 col-6 mt-6 pt-2 ">
                        <div class="d-flex justify-content-start align-items-start">
                            <a href="{{ URL::to('/panel-team/report/certificate-origin-no627120/add') }}" class="" target="_blank">
                            <button type="submit" class="btn btn report-tab-active"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center space-between ">
                                    ...
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/certificate-origin-no627120/view/'.$value->id) }}" class="" target="_blank" title="View Reports">
                                        View
                                    </a>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;"  href="{{ URL::to('/panel-team/report/certificate-origin-no627120/edit/'.$value->id) }}" class="" target="_blank" title="Edit Reports">
                                        Edit
                                    </a>
                                    ...
                                    <span></span>
                                    <a  class="btn btn-sm report-tab-active" style="font-size: 10px;" href="{{ URL::to('/panel-team/report/certificate-origin-no627120/generate_certificate_origin_no627120_invoic_PDF/'.$value->id) }}" class="" target="_blank" title="View Pdf">
                                    PDF
                                </a>
