        ...
        <div class="card">
            <div class="card-body justify-content-start">
                <form id="firm-step-form" enctype="multipart/form-data">
                    ...
                    <h4 class="card-title"> {{ strtoupper('Certificate origins form A Edit') }} <br>
                    ...
                    <div class="row">
                            ...
                            <select class="multi-select" name="commercial_invoice_id" placeholder="Select status Party">
                                ...
                                @forelse ($getAllInvoice as $item)
                                    <option value="{{ $item->id }}"
                                        {{ isset($CertificateOriginComDecFormA) && $item->id == $CertificateOriginComDecFormA->commercial_invoice_id ? 'selected' : '' }}>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input"
                                id="certificate_origin_com_decs_from_a_invoices"
                                name="certificate_origin_com_decs_from_a_invoices"
                                value="{{ $CertificateOriginComDecFormA->{'certificate_origin_com_decs_from_a_invoices'} }}">
                            <input type="hidden" class="form-control custom-input" id="id" name="id"
                                value="{{ $CertificateOriginComDecFormA->{'id'} }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="exporter_name" name="exporter_name"
                                value="{{ $CertificateOriginComDecFormA->{'exporter_name'} }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="exporter_address"
                                name="exporter_address" value="{{ $CertificateOriginComDecFormA->{'exporter_address'} }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="exporter_country"
                                name="exporter_country"value="{{ $CertificateOriginComDecFormA->{'exporter_country'} }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="consignee_name"
                                name="consignee_name" value="{{ $CertificateOriginComDecFormA->{'consignee_name'} }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="consignee_address"
                                name="consignee_address"value="{{ $CertificateOriginComDecFormA->{'consignee_address'} }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="consignee_country"
                                name="consignee_country"value="{{ $CertificateOriginComDecFormA->{'consignee_country'} }}">
                        </div>

                        <div class="col-sm-3 mb-3">
                            <label for="ref_number" class="form-label">Ref number </label>
                            <input type="text" class="form-control custom-input" id="ref_number"
                                name="ref_number"value="{{ $CertificateOriginComDecFormA->{'ref_number'} }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="issue_country"
                                name="issue_country"value="{{ $CertificateOriginComDecFormA->{'issue_country'} }}">
                        </div>

                        <div class="col-sm-3 mb-3">
                            <label for="transport_and_route" class="form-label">Transport and route</label>
                            <input type="text" class="form-control custom-input" id="transport_and_route"
                                name="transport_and_route"
                                value="{{ $CertificateOriginComDecFormA->{'transport_and_route'} }}">
                        </div>

                        <div class="col-sm-3 mb-3">
                            <label for="bl_date" class="form-label">Transport and route Date</label>
                            <input type="text" class="form-control custom-input" id="bl_date" name="bl_date"
                                value="{{ $CertificateOriginComDecFormA->{'bl_date'} }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            <label for="bl_no" class="form-label">Transport BL NO</label>
                            <input type="text" class="form-control custom-input" id="bl_no" name="bl_no"
                                value="{{ $CertificateOriginComDecFormA->{'bl_no'} }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="produce_in_country"
                                name="produce_in_country"
                                value="{{ $CertificateOriginComDecFormA->{'produce_in_country'} }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            <label for="importing_in_country" class="form-label">Importing in country </label>
                            <input type="text" class="form-control custom-input" id="importing_in_country"
                                name="importing_in_country"
                                value="{{ $CertificateOriginComDecFormA->{'importing_in_country'} }}">
                        </div>
                        ...
                        <div class="col-sm-3 mb-3">
                            ...
                            <input type="date" class="form-control custom-input" id="date"
                                name="date"value="{{ $CertificateOriginComDecFormA->{'date'} }}">
                        </div>
                        <div class="col-sm-3 mb-3">
                            <label for="place" class="form-label">Place</label>
                            <input type="text" class="form-control custom-input" id="place" name="place"
                                value="{{ $CertificateOriginComDecFormA->{'place'} }}">
                        </div>
                    ...
                    <div class="row">
                        ...
                        @for ($i = 3; $i <= 3; $i++)
                            <div class="col-sm-4 mb-4">
                                ...
                                <input type="text" class="form-control custom-input"
                                    id="item_number_{{ $i }}" name="item_number_{{ $i }}"
                                    value="{{ $CertificateOriginComDecFormA->{'item_number_' . $i} }}">
                            </div>
                        @endfor
                        ...
                        @for ($i = 3; $i <= 3; $i++)
                            <div class="col-sm-4 mb-4">
                                ...
                                <input type="text" class="form-control custom-input"
                                    ...
                                    value="{{ $CertificateOriginComDecFormA->{'marks_and_numbers_' . $i} }}">
                            </div>
                        @endfor
                    </div>
                    <div class="row">
                        @for ($i = 3; $i <= 14; $i++)
                            <div class="col-sm-4 mb-4">
                                <label for="numbers_and_kinds_of_packges_description_{{ $i }}"
                                    class="form-label">Numbers and kinds of packges description</label>
                                <input type="text" step="any" class="form-control custom-input"
                                    id="numbers_and_kinds_of_packges_description_{{ $i }}"
                                    name="numbers_and_kinds_of_packges_description_{{ $i }}"
                                    value="{{ $CertificateOriginComDecFormA->{'numbers_and_kinds_of_packges_description_' . $i} }}">
                            </div>
                        @endfor
                    </div>
                    <div class="row">
                        @for ($i = 3; $i <= 3; $i++)
                            <div class="col-sm-4 mb-4">
                                <label for="origin_criterion_{{ $i }}" class="form-label">Origin
                                    criterion</label>
                                <input type="text" step="any" class="form-control custom-input"
                                    id="origin_criterion_{{ $i }}"
                                    name="origin_criterion_{{ $i }}"
                                    value="{{ $CertificateOriginComDecFormA->{'origin_criterion_' . $i} }}">
                            </div>
                        @endfor
                    </div>
                    <div class="row">
                        @for ($i = 3; $i <= 14; $i++)
                            <div class="col-sm-3 mb-4">
                                ...
                                <input type="text" step="any" class="form-control custom-input"
                                    ...
                                    value="{{ $CertificateOriginComDecFormA->{'gross_weight_or_other_quantity_' . $i} }}">
                            </div>
                        @endfor
                        @for ($i = 3; $i <= 14; $i++)
                            <div class="col-sm-3 mb-4">
                                <label for="number_and_dates_of_inovoices_{{ $i }}" class="form-label">Number
                                    and dates of inovoices </label>
                                <input type="text" step="any" class="form-control custom-input"
                                    id="number_and_dates_of_inovoices_{{ $i }}"
                                    name="number_and_dates_of_inovoices_{{ $i }}"
                                    value="{{ $CertificateOriginComDecFormA->{'number_and_dates_of_inovoices_' . $i} }}">
                            </div>
                        @endfor
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('#firm-step-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('team.update_submit_certificate_origin_com_dec_form_a_invoice') }}",
                    data: formData,
                    dataType: "json",
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            willClose: () => {
                                ...
                                //    "{{ route('team.report_List_certificate_origin_com_dec_form_a_invoice') }}"
