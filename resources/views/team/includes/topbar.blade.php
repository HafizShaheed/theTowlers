	...
	<div class="nav-header">
	    <a href="index.html" class="brand-logo">
	        ...
	        <img class="logo-abbr" src="{{URL::to('/public/admin/assets/images/logo/logo.png')}}" width="70" height="53"
	            alt="Image">
	                            ...
	                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
	                                ...
	                                <div class="header-info2 d-flex align-items-center">
	                                    ...
	                                    <div class="header-info">
	                                        <h6> {{ Auth::guard('team')->user() ?    Auth::guard('team')->user()->first_name : 'team Member'   }}
	                                        </h6>
	                                        <p> {{ Auth::guard('team')->user()->team_email  }}</p>
	                            ...
	                            <div class="dropdown-menu dropdown-menu-end" style="">
	                                <div class="card border-0 mb-0">
	                                    <div class="card-header py-2">
	                                        <div class="products">
	                                            <img src="{{URL::to('/public/admin/assets')}}/images/tab/1.jpg"
	                                                class="avatar avatar-md" alt="">
	                                            <div>
	                                                <h6> {{ Auth::guard('team')->user() ?    Auth::guard('team')->user()->first_name : 'team Member'   }}
	                                                </h6>

	                                                <span>{{ Auth::guard('team')->user()->team_email  }}</span>
	                                            </div>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="card-footer px-0 py-2">
	                                        ...
	                                        <a href="{{route('team.logout')}}" class="dropdown-item ai-icon">
	                                            <svg class="profle-logout" xmlns="" width="18" height="18"
	                                                viewBox="0 0 24 24" fill="none" stroke="#ff7979" stroke-width="2"
	                                                stroke-linecap="round" stroke-linejoin="round">
