                                                    ...
                                                    @for ($i = 1; $i <= 18; $i++)
                                                        ...
                                                        <!-- <tr>
                                                            ...
                                                            <a href="{{ URL::to('/company/report/document_file_download'.'/'.base64_encode($Document->id)) }}" class="download-license-btn" style="display: inline-block; width: 200px;  text-align: center; ">Download Document</a>
                                                                <a href="{{ URL::to('/company/report/document_file_view'.'/'.base64_encode($Document->id)) }}" target="" class="download-license-btn" style="display: inline-block; width: 200px;  text-align: center; ">View Document</a>
                                                            </td>
                                            ...
                                            <table class="table primary-table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <a href="{{ URL::to('/company/report/onGround_file_download'.'/'. base64_encode($OnGroundVerification->id)) }}" class="download-license-btn" style="display: inline-block; width: 200px;  text-align: center; ">Download PDF or Image</a>
                                                       <a href="{{ URL::to('/company/report/onGround_file_view'.'/'. base64_encode($OnGroundVerification->id)) }}" target="" class="download-license-btn" style="display: inline-block; width: 200px;  text-align: center; ">View Report </a></td>
